...
- `/grok-cc:adversarial-review` uses the same review target selection as `/grok-cc:review`.
- It supports working-tree review, branch review, and `--base <ref>`.
- It does not support `--scope staged` or `--scope unstaged`.
- Unlike `/grok-cc:review`, it can still take extra focus text after the flags.
...
- After launching the command, tell the user: "Grok adversarial review started in the background. Check `/grok-cc:status` for progress."
