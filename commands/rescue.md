...
argument-hint: "[--background|--wait] [--resume|--fresh] [--model <model|fast>] [--effort <none|minimal|low|medium|high|xhigh|max>] [what Grok should investigate, solve, or continue]"
